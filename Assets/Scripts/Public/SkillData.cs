...
public class SkillData : INetworkSerializable
{
    ...
    public void NetworkSerialize<T>(BufferSerializer<T> serializer) where T : IReaderWriter
    {
        ...
        PublicFunc.SerializeClassList(serializer, ref Damage);
        PublicFunc.SerializeClassList(serializer, ref Buffs);
        PublicFunc.SerializeClassList(serializer, ref DeBuffs);
        PublicFunc.SerializeEnumList(serializer, ref WeaponType);
    }
}
