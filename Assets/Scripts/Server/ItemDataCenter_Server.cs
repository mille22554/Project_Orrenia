...
public static class ItemDataCenter_Server
{
    ...
    public static FullAbilityBase FinalAbilityProcess(BagItemData itemData)
    {
        ...
        final.STR = (int)(tempSTR * (1 + final.STR / 10));
        final.DEX = (int)(tempDEX * (1 + final.DEX / 10));
        final.INT = (int)(tempINT * (1 + final.INT / 10));
        final.VIT = (int)(tempVIT * (1 + final.VIT / 10));
        final.AGI = (int)(tempAGI * (1 + final.AGI / 10));
        final.LUK = (int)(tempLUK * (1 + final.LUK / 10));
        final.HP = (int)(tempHP * (1 + final.HP / 10));
        final.MP = (int)(tempMP * (1 + final.MP / 10));
        final.STA = (int)(tempSTA * (1 + final.STA / 10));
        final.ATK = (int)(tempATK * (1 + final.ATK / 10));
        final.MATK = (int)(tempMATK * (1 + final.MATK / 10));
        final.DEF = (int)(tempDEF * (1 + final.DEF / 10));
        final.MDEF = (int)(tempMDEF * (1 + final.MDEF / 10));
        final.ACC = (int)(tempACC * (1 + final.ACC / 10));
        final.EVA = (int)(tempEVA * (1 + final.EVA / 10));
        final.CRIT = (int)(tempCRIT * (1 + final.CRIT / 10));
        final.SPD = (int)(tempSPD * (1 + final.SPD / 10));
